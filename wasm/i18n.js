const translations = {
    "en": {
        ...
        "verify_all_ok": "✅ All {n} files verified OK.",
        "verify_has_errors": "❌ {f} of {n} files failed verification.",
        "verify_index_only": "Index-only archive — no data to verify",
        "verify_skip": "—",
        ...
        "alert_need_paf": "Please select a .paf file.",
    ...
    "ja": {
        ...
        "verify_btn": "整合性を検証",
        "verify_running": "検証中…",
        "verify_all_ok": "✅ 全 {n} ファイルの検証に成功しました。",
        "verify_has_errors": "❌ {n} 件中 {f} 件の検証に失敗しました。",
        "verify_index_only": "インデックスのみのアーカイブ — データがないため検証不可",
        "verify_skip": "—",
        "entry_deleted": "削除済み",
        ...
        "alert_need_paf": ".paf ファイルを選択してください。",
    ...
    "zh": {
        "title": "📦 PAF 网页工具",
        "subtitle": "开放容器 · 防病毒透明 · 每文件SHA-256",
        ...
        "verify_btn": "验证完整性",
        "verify_running": "验证中…",
        "verify_all_ok": "✅ 全部 {n} 个文件验证通过。",
        "verify_has_errors": "❌ {n} 个文件中有 {f} 个验证失败。",
        "verify_index_only": "仅索引存档 — 无数据可验证",
        "verify_skip": "—",
        "entry_deleted": "已删除",
        "extract_btn": "全部提取到虚拟FS",
        "extract_local_btn": "提取到PC文件夹",
        "extract_local_success": "✅ 成功保存到PC文件夹。",
    ...
    "ar": {
        ...
        "extract_local_success": "✅ Guardado en carpeta PC.",
        "extract_local_btn": "Extraer a carpeta PC",
        "entry_deleted": "eliminado",
        "verify_skip": "—",
        "verify_index_only": "Solo índice — sin datos para verificar",
        "verify_has_errors": "❌ {f} de {n} archivos fallaron.",
        "verify_all_ok": "✅ {n} archivos verificados.",
        "verify_running": "Verificando…",
        "verify_btn": "Verificar integridad",
        "th_status": "Estado",
        "th_hash": "SHA-256",
    },
    "fr": {
    ...
    "pt": {
        ...
        "extract_local_success": "✅ Сохранено в папку PC.",
        "extract_local_btn": "Извлечь в папку PC",
        "entry_deleted": "удалён",
        "verify_skip": "—",
        "verify_index_only": "Только индекс — нет данных",
        "verify_has_errors": "❌ {f} из {n} файлов не прошли.",
        "verify_all_ok": "✅ {n} файлов проверено.",
        "verify_running": "Проверка…",
        "verify_btn": "Проверить целостность",
        "th_status": "Статус",
        "th_hash": "SHA-256",
        "extract_local_success": "✅ Enregistré dans le dossier PC.",
        "extract_local_btn": "Extraire vers dossier PC",
        "entry_deleted": "supprimé",
        "verify_skip": "—",
        "verify_index_only": "Index seulement — pas de données",
        "verify_has_errors": "❌ {f} sur {n} fichiers ont échoué.",
        "verify_all_ok": "✅ {n} fichiers vérifiés.",
        "verify_running": "Vérification…",
        "verify_btn": "Vérifier l'intégrité",
        "th_status": "Statut",
        "th_hash": "SHA-256",
    },
    "de": {
    ...
    "it": {
        ...
        "extract_local_success": "✅ Im PC-Ordner gespeichert.",
        "extract_local_btn": "In PC-Ordner extrahieren",
        "entry_deleted": "gelöscht",
        "verify_skip": "—",
        "verify_index_only": "Nur Index — keine Daten",
        "verify_has_errors": "❌ {f} von {n} Dateien fehlgeschlagen.",
        "verify_all_ok": "✅ {n} Dateien geprüft.",
        "verify_running": "Prüfen…",
        "verify_btn": "Integrität prüfen",
        "th_status": "Status",
        "th_hash": "SHA-256",
    }
};
