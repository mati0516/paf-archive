const translations = {
    "en": {
        ...
        "th_path": "File Path",
        "th_size": "Size (Bytes)",
        "extract_btn": "Extract to Virtual FS (Preview)",
        "extract_local_btn": "Extract to PC Folder",
        "extract_local_success": "✅ Successfully saved to PC folder.",
    ...
    "ja": {
        ...
        "th_path": "ファイルパス",
        "th_size": "サイズ (バイト)",
        "extract_btn": "仮想FSにすべて展開 (プレビュー)",
        "extract_local_btn": "PCのフォルダに展開",
        "extract_local_success": "✅ PCのフォルダに正常に保存されました。",
